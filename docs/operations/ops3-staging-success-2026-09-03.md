...
이 문서는 a703 SHA의 당시 증거를 보존합니다. 이후 음성 자료 조회 상한을 포함한 2a3 SHA의 Staging 배포와 실제 AI·음성·WebP 전체 검증까지 성공했으며, 현재 상태는 [후속 배포·실제 검증 완료 기록](ops3-staging-verified-2026-09-03.md)을 따릅니다. 아래 당시 미완료 항목을 소급해 성공으로 바꾸지 않습니다.
