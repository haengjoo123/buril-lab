...
Ops 4 적용과 사전·사후 전체 논리 덤프 비교까지 완료했습니다. 실제 적용 결과와
검증 중 발견한 단일 이력 처리 결함의 수정 내용은
[Ops 4 운영 마이그레이션 이력 정리 증거](./ops4-production-migration-history-evidence-2026-09-05.md)에
분리해 기록합니다.
