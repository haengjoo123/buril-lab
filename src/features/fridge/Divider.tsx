...
export const Divider: React.FC<DividerProps> = ({ position, shelfWidth, shelfDepth, height, dimmed = false, isDarkMode = false }) => {
    ...
    return (
        <mesh position={[x, y, 0]} castShadow>
            ...
            <meshStandardMaterial color={isDarkMode ? '#64748b' : '#94a3b8'} transparent opacity={opacity} />
        </mesh>
    );
};
