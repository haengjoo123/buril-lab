...
export const LabContextSwitcher: React.FC<LabContextSwitcherProps> = ({ variant = 'header', userEmail }) => {
    ...
    return (
        <div className={isSidebar ? 'relative min-w-0 w-full' : 'relative min-w-0 max-w-[128px]'}>
            <button
                ...
                className={isSidebar
                    ...
                    : 'flex max-w-full items-center gap-1 text-sm font-medium text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 px-2 py-1.5 rounded-md transition-colors whitespace-nowrap overflow-hidden'}
            ...
            {isOpen && (
                <>
                    ...
                    <div className={`${isSidebar ? 'absolute bottom-full left-0 mb-2 w-full min-w-56' : 'absolute top-full right-0 mt-1 w-56'} bg-white dark:bg-slate-800 rounded-xl shadow-lg border border-slate-100 dark:border-slate-700 py-2 z-50`}>
